    ...
    <section className="py-24 px-4 bg-[hsl(220,25%,10%)]">
      <div className="container max-w-6xl">
        <div className="text-center mb-16">
          <h2 className="text-3xl font-bold mb-4 text-cyan-200">Areas of Expertise</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {expertise.map((item, index) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="glass p-6 rounded-2xl hover-lift border border-cyan-500/20 bg-[hsl(220,30%,12%)]/50"
            >
              <div className="w-12 h-12 bg-cyan-500/20 text-cyan-300 rounded-xl flex items-center justify-center mb-4">
                {item.icon}
              </div>
